...
Complete commands for building the entire homelab in the correct order.

> Pi-hole = VM on Proxmox (CT 100, VLAN 10, 192.168.10.2)
...
| [03-switch-setup.md](./03-switch-setup.md) | Step 3 | Managed switch 802.1Q |
